...
Grupo: IM-03
Alumno: David Aturo García Medellín
Matrícula: 2530228
...
"""
Este proyecto reúne siete programas en Python que trabajan con números, valores
booleanos y cadenas de texto. En cada ejercicio se usan validaciones básicas,
condiciones, manejo simple de errores y formatos de salida para que los resultados
se entiendan fácilmente.

Los programas muestran cómo usar enteros y flotantes en operaciones comunes, cómo
modificar textos con métodos de cadena y cómo aplicar valores booleanos para tomar
decisiones dentro del código. Estos temas se aplican en situaciones prácticas como
conversiones, revisiones de datos, comparaciones y organización de información que
escribe el usuario.

También se reforzaron habilidades importantes en programación, como planear un
algoritmo, documentar entradas y salidas, crear casos de prueba y evitar fallos con
validaciones básicas. En general, este trabajo ayuda a entender mejor cómo Python
maneja datos, hace cálculos y ejecuta decisiones lógicas dentro de programas que
